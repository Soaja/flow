  ...
  return (
    <section id="manifesto" ref={sectionRef} className="about-screen">
      ...
      <style>{`
        ...
        .about-layout{width:min(1240px,100%);margin:auto;display:block;transform:translateY(clamp(-38px,-3.5vh,-18px))}
